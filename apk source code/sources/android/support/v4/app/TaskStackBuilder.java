...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    @RequiresApi(16)
    public static class TaskStackBuilderApi16Impl extends TaskStackBuilderBaseImpl {
    ...
    @NonNull
    public TaskStackBuilder addParentStack(@NonNull Activity activity2) {
        Intent supportParentActivityIntent = activity2 instanceof SupportParentable ? ((SupportParentable) activity2).getSupportParentActivityIntent() : null;
        if (supportParentActivityIntent == null) {
            supportParentActivityIntent = NavUtils.getParentActivityIntent(activity2);
        }
        if (supportParentActivityIntent != null) {
