...
public enum SubscriptionHelper implements Subscription {
    ...
    public static void reportMoreProduced(long j) {
        RxJavaPlugins.onError(new ProtocolViolationException(g9.a("More produced than requested: ", j)));
    }
    ...
    public static boolean validate(long j) {
        ...
        RxJavaPlugins.onError(new IllegalArgumentException(g9.a("n > 0 required but it was ", j)));
        return false;
    }
