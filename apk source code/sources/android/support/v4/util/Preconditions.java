...
public class Preconditions {
    ...
    public static float checkArgumentFinite(float f, String str) {
        if (Float.isNaN(f)) {
            throw new IllegalArgumentException(g9.b(str, " must not be NaN"));
        }
        if (Float.isInfinite(f)) {
            throw new IllegalArgumentException(g9.b(str, " must not be infinite"));
        }
        return f;
    }
    ...
    public static <T> T[] checkArrayElementsNotNull(T[] tArr, String str) {
        if (tArr == null) {
            throw new NullPointerException(g9.b(str, " must not be null"));
        }
    ...
    public static <T> Collection<T> checkCollectionNotEmpty(Collection<T> collection, String str) {
        ...
        if (collection.isEmpty()) {
            throw new IllegalArgumentException(g9.b(str, " is empty"));
        }
        return collection;
    }
    ...
    public static int checkFlagsArgument(int i, int i2) {
        ...
        StringBuilder sbA = g9.a("Requested flags 0x");
        sbA.append(Integer.toHexString(i));
        sbA.append(", but only 0x");
        sbA.append(Integer.toHexString(i2));
        sbA.append(" are allowed");
