...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, g6.a {
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new g6(this);
        }
    ...
    public View getView(int i, View view2, ViewGroup viewGroup) {
        ...
        if (!this.mCursor.moveToPosition(i)) {
            throw new IllegalStateException(g9.b("couldn't move cursor to position ", i));
        }
        if (view2 == null) {
