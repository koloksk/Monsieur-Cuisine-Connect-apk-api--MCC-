...
public final class UPCAReader extends UPCEANReader {
    ...
    public Result decode(BinaryBitmap binaryBitmap) throws NotFoundException, FormatException {
        return a(this.i.decode(binaryBitmap));
    }
    ...
    public Result decodeRow(int i, BitArray bitArray, int[] iArr, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        return a(this.i.decodeRow(i, bitArray, iArr, map));
    }

    public static Result a(Result result) throws FormatException {
