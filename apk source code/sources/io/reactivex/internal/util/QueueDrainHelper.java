...
public final class QueueDrainHelper {
    ...
    public static <T> boolean a(long j, Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        boolean asBoolean;
        boolean asBoolean2;
        ...
        while (true) {
            if (j2 != j) {
                ...
                try {
                    asBoolean2 = booleanSupplier.getAsBoolean();
                } catch (Throwable th2) {
