...
public final class MultiFormatUPCEANReader extends OneDReader {
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException, NumberFormatException {
        int[] iArrA = UPCEANReader.a(bitArray);
        for (UPCEANReader uPCEANReader : this.a) {
            try {
                Result resultDecodeRow = uPCEANReader.decodeRow(i, bitArray, iArrA, map);
