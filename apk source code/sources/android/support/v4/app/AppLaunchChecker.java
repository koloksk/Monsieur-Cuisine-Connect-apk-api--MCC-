...
public class AppLaunchChecker {
    ...
    public static void onActivityCreate(@NonNull Activity activity2) {
        Intent intent;
        SharedPreferences sharedPreferences = activity2.getSharedPreferences(SHARED_PREFS_NAME, 0);
        if (sharedPreferences.getBoolean(KEY_STARTED_FROM_LAUNCHER, false) || (intent = activity2.getIntent()) == null || !"android.intent.action.MAIN".equals(intent.getAction())) {
            return;
        }
