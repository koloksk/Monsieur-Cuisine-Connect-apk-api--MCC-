...
public class SymbolInfo {
    ...
    public static SymbolInfo a(int i, SymbolShapeHint symbolShapeHint, boolean z) {
    ...
    public static SymbolInfo lookup(int i, SymbolShapeHint symbolShapeHint, Dimension dimension, Dimension dimension2, boolean z) {
        ...
        if (z) {
            throw new IllegalArgumentException(g9.a("Can't find a symbol arrangement that matches the message. Data codewords: ", i));
        }
        return null;
    }
}
