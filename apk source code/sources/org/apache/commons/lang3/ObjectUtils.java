    ...
    public static <T> T clone(T t) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        ...
        if (!t.getClass().isArray()) {
            try {
                ...
                StringBuilder sbA = g9.a("Cannot clone Cloneable type ");
                sbA.append(t.getClass().getName());
                throw new CloneFailedException(sbA.toString(), e);
            } catch (NoSuchMethodException e2) {
                StringBuilder sbA2 = g9.a("Cloneable type ");
                sbA2.append(t.getClass().getName());
                sbA2.append(" has no clone method");
                throw new CloneFailedException(sbA2.toString(), e2);
            } catch (InvocationTargetException e3) {
                StringBuilder sbA3 = g9.a("Exception cloning Cloneable type ");
                sbA3.append(t.getClass().getName());
                throw new CloneFailedException(sbA3.toString(), e3.getCause());
            }
        }
