...
public final class ObservableFlatMapMaybe<T, R> extends bl<T, R> {
    ...
    public static final class a<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public final class C0060a extends AtomicReference<Disposable> implements MaybeObserver<R>, Disposable {
                ...
                if (aVar.get() == 0) {
                    if (aVar.compareAndSet(0, 1)) {
                        ...
                        if (!z || (spscLinkedArrayQueue != null && !spscLinkedArrayQueue.isEmpty())) {
                            ...
                            Throwable thTerminate = aVar.e.terminate();
                            if (thTerminate != null) {
        ...
        */
        public void a(io.reactivex.internal.operators.observable.ObservableFlatMapMaybe.a<T, R>.C0060a r3, R r4) {
            /*
                r2 = this;
            ...
            L81:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.observable.ObservableFlatMapMaybe.a.a(io.reactivex.internal.operators.observable.ObservableFlatMapMaybe$a$a, java.lang.Object):void");
        }
        ...
        public void onNext(T t) {
            try {
                ...
                if (this.i || !this.c.add(c0060a)) {
                    return;
                }
                maybeSource.subscribe(c0060a);
            } catch (Throwable th) {
