...
public abstract class FragmentTransaction {
    ...
    public abstract FragmentTransaction add(@IdRes int i, Fragment fragment2);

    public abstract FragmentTransaction add(@IdRes int i, Fragment fragment2, @Nullable String str);

    public abstract FragmentTransaction add(Fragment fragment2, String str);
    ...
    public abstract FragmentTransaction attach(Fragment fragment2);
    ...
    public abstract FragmentTransaction detach(Fragment fragment2);

    public abstract FragmentTransaction disallowAddToBackStack();

    public abstract FragmentTransaction hide(Fragment fragment2);

    public abstract boolean isAddToBackStackAllowed();

    public abstract boolean isEmpty();

    public abstract FragmentTransaction remove(Fragment fragment2);

    public abstract FragmentTransaction replace(@IdRes int i, Fragment fragment2);

    public abstract FragmentTransaction replace(@IdRes int i, Fragment fragment2, @Nullable String str);
    ...
    public abstract FragmentTransaction setPrimaryNavigationFragment(Fragment fragment2);
    ...
    public abstract FragmentTransaction show(Fragment fragment2);
}
