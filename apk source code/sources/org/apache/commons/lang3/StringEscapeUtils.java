...
public class StringEscapeUtils {
    ...
    public static class a extends CharSequenceTranslator {
        ...
        public static final char[] c = {',', '\"', CharUtils.CR, '\n'};
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            ...
            if (StringUtils.containsNone(charSequence.toString(), c)) {
                ...
                writer.write(34);
                writer.write(StringUtils.replace(charSequence.toString(), b, b + b));
                writer.write(34);
            }
    ...
    public static class b extends CharSequenceTranslator {
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            ...
            if (StringUtils.containsAny(string, c)) {
                writer.write(StringUtils.replace(string, b + b, b));
            } else {
                writer.write(charSequence.toString());
            }
            return Character.codePointCount(charSequence, 0, charSequence.length());
