...
public final class MonochromeRectangleDetector {
    ...
    public final ResultPoint a(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) throws NotFoundException {
        int[] iArr = null;
        int i10 = i;
        int i11 = i5;
        while (i11 < i8 && i11 >= i7 && i10 < i4 && i10 >= i3) {
            int[] iArrA = i2 == 0 ? a(i11, i9, i3, i4, true) : a(i10, i9, i7, i8, false);
            if (iArrA == null) {
                if (iArr == null) {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int i5 = i / 2;
        ResultPoint resultPointA = a(i2, -iMax2, 0, width, i, 0, y, height, i5);
        int x = ((int) resultPointA.getX()) - 1;
        ResultPoint resultPointA2 = a(i2, iMax2, x, width, i, 0, y, height, i5);
        int x2 = ((int) resultPointA2.getX()) + 1;
        ResultPoint resultPointA3 = a(i2, 0, x, x2, i, iMax, y, height, i4);
        return new ResultPoint[]{a(i2, 0, x, x2, i, i3, y, ((int) resultPointA3.getY()) + 1, i2 / 4), resultPointA, resultPointA2, resultPointA3};
    }
