...
public class FrameMetricsAggregator {
    ...
    public static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        public void add(Activity activity2) {
            ...
            this.mActivities.add(new WeakReference<>(activity2));
        }
        ...
        @Override // android.support.v4.app.FrameMetricsAggregator.FrameMetricsBaseImpl
        public SparseIntArray[] remove(Activity activity2) {
    ...
    public void add(@NonNull Activity activity2) {
        this.mInstance.add(activity2);
    }
    ...
    @Nullable
    public SparseIntArray[] remove(@NonNull Activity activity2) {
        return this.mInstance.remove(activity2);
    }
