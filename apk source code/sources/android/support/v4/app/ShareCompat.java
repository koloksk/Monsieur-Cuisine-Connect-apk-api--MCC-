...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        public IntentBuilder(Activity activity2) {
            this.mActivity = activity2;
            Intent action = new Intent().setAction("android.intent.action.SEND");
            this.mIntent = action;
            action.putExtra(ShareCompat.EXTRA_CALLING_PACKAGE, activity2.getPackageName());
            this.mIntent.putExtra(ShareCompat.EXTRA_CALLING_ACTIVITY, activity2.getComponentName());
        ...
        public static IntentBuilder from(Activity activity2) {
            return new IntentBuilder(activity2);
        }
    ...
    public static class IntentReader {
        ...
        public IntentReader(Activity activity2) {
            this.mActivity = activity2;
        ...
        public static IntentReader from(Activity activity2) {
        ...
        public Uri getStream(int i) {
            ...
            StringBuilder sbA = g9.a("Stream items available: ");
    ...
    public static void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
        ...
        StringBuilder sbA = g9.a(HISTORY_FILENAME_PREFIX);
        sbA.append(intentBuilder.getActivity().getClass().getName());
        shareActionProvider.setShareHistoryFileName(sbA.toString());
        shareActionProvider.setShareIntent(intentBuilder.getIntent());
        menuItem.setActionProvider(shareActionProvider);
    }

    public static ComponentName getCallingActivity(Activity activity2) {
        ComponentName callingActivity = activity2.getCallingActivity();
        return callingActivity == null ? (ComponentName) activity2.getIntent().getParcelableExtra(EXTRA_CALLING_ACTIVITY) : callingActivity;
    }

    public static String getCallingPackage(Activity activity2) {
        String callingPackage = activity2.getCallingPackage();
        return callingPackage == null ? activity2.getIntent().getStringExtra(EXTRA_CALLING_PACKAGE) : callingPackage;
    }
