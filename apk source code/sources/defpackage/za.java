...
public final class za {
    ...
    public final synchronized void a() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{SoundLength.SMALL_THRESHOLD, 379}, "FR");
            a(new int[]{380}, "BG");
            a(new int[]{383}, "SI");
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            ...
            a(new int[]{SoundLength.SHORT, 509}, "GB");
            a(new int[]{520}, "GR");
            ...
            a(new int[]{594}, "RO");
            a(new int[]{599}, "HU");
            a(new int[]{Limits.TURBO_MAX_SECONDS, 601}, "ZA");
            a(new int[]{603}, "GH");
            a(new int[]{608}, "BH");
            a(new int[]{609}, "MU");
            a(new int[]{611}, "MA");
            ...
            a(new int[]{SoundLength.MIDDLE, 839}, "IT");
