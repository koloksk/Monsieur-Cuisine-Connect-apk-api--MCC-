...
public final class DataMatrixWriter implements Writer {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) {
        ...
        int symbolDataWidth = symbolInfoLookup.getSymbolDataWidth();
        int symbolDataHeight = symbolInfoLookup.getSymbolDataHeight();
        ByteMatrix byteMatrix = new ByteMatrix(symbolInfoLookup.getSymbolWidth(), symbolInfoLookup.getSymbolHeight());
        int i3 = 0;
        for (int i4 = 0; i4 < symbolDataHeight; i4++) {
            if (i4 % symbolInfoLookup.matrixHeight == 0) {
                int i5 = 0;
                for (int i6 = 0; i6 < symbolInfoLookup.getSymbolWidth(); i6++) {
            ...
            i3++;
            int i10 = symbolInfoLookup.matrixHeight;
            if (i4 % i10 == i10 - 1) {
                int i11 = 0;
                for (int i12 = 0; i12 < symbolInfoLookup.getSymbolWidth(); i12++) {
