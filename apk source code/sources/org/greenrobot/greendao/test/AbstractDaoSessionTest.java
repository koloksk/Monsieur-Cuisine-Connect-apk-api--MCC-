...
public abstract class AbstractDaoSessionTest<T extends AbstractDaoMaster, S extends AbstractDaoSession> extends DbTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        try {
            this.daoMaster = this.b.getConstructor(Database.class).newInstance(this.f10db);
            this.b.getMethod("createAllTables", Database.class, Boolean.TYPE).invoke(null, this.f10db, false);
