...
public final class ObservableMergeWithMaybe<T> extends bl<T, T> {
    ...
    public static final class a<T> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public final C0063a<T> c = new C0063a<>(this);
        ...
        public static final class C0063a<T> extends AtomicReference<Disposable> implements MaybeObserver<T> {
