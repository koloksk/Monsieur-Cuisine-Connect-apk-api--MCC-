...
public class Conversion {
    ...
    public static final boolean[] o = {true, false, false, false};
    ...
    */
    public static boolean[] hexDigitMsb0ToBinary(char r3) {
        ...
        L9:
            ...
            throw r0
        L25:
            boolean[] r3 = org.apache.commons.lang3.Conversion.a
    ...
    */
    ...
    public static char intToHexDigit(int i2) {
        char cForDigit = Character.forDigit(i2, 16);
        if (cForDigit != 0) {
            return cForDigit;
        }
        throw new IllegalArgumentException(g9.b("nibble value not between 0 and 15: ", i2));
    }
    ...
    public static char binaryToHexDigitMsb0_4bits(boolean[] zArr, int i2) {
        if (zArr.length > 8) {
            StringBuilder sbA = g9.a("src.length>8: src.length=");
        ...
        StringBuilder sbA2 = g9.a("src.length-srcPos<4: src.length=");
        sbA2.append(zArr.length);
        sbA2.append(", srcPos=");
        sbA2.append(i2);
