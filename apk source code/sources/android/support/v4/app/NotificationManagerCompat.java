    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerRecord) {
            ...
            if (zBindService) {
                ...
                StringBuilder sbA = g9.a("Unable to bind to listener ");
        ...
        private void processListenerQueue(ListenerRecord listenerRecord) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                StringBuilder sbA = g9.a("Processing component ");
                sbA.append(listenerRecord.componentName);
                sbA.append(", ");
            ...
            while (true) {
                ...
                try {
                    ...
                    if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                        StringBuilder sbA2 = g9.a("Remote service has died: ");
                        sbA2.append(listenerRecord.componentName);
                        Log.d(NotificationManagerCompat.TAG, sbA2.toString());
                    }
                } catch (RemoteException e) {
                    StringBuilder sbA3 = g9.a("RemoteException communicating with ");
                    sbA3.append(listenerRecord.componentName);
                    Log.w(NotificationManagerCompat.TAG, sbA3.toString(), e);
                }
            }
            if (listenerRecord.taskQueue.isEmpty()) {
                return;
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            ...
            if (i > 6) {
                StringBuilder sbA = g9.a("Giving up on delivering ");
                sbA.append(listenerRecord.taskQueue.size());
                sbA.append(" tasks to ");
                sbA.append(listenerRecord.componentName);
                sbA.append(" after ");
        ...
        private void updateListenerMap() {
            ...
            while (it2.hasNext()) {
                ...
                if (!hashSet.contains(next.getKey())) {
                    if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                        StringBuilder sbA = g9.a("Removing listener record for ");
