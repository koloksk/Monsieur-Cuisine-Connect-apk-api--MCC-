...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static Observable<Integer> range(int i, int i2) {
        if (i2 < 0) {
            throw new IllegalArgumentException(g9.b("count >= 0 required but it was ", i2));
        }
        if (i2 == 0) {
            return empty();
        }
    ...
    public static Observable<Long> rangeLong(long j, long j2) {
        if (j2 < 0) {
            throw new IllegalArgumentException(g9.a("count >= 0 required but it was ", j2));
        }
        if (j2 == 0) {
            return empty();
        }
    ...
    public final Maybe<T> elementAt(long j) {
        ...
        throw new IndexOutOfBoundsException(g9.a("index >= 0 required but it was ", j));
    }
    ...
    public final Observable<T> skipLast(int i) {
        ...
        throw new IndexOutOfBoundsException(g9.b("count >= 0 required but it was ", i));
    }
    ...
    public final Observable<T> take(long j) {
        ...
        throw new IllegalArgumentException(g9.a("count >= 0 required but it was ", j));
    }
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        return iOrdinal != 0 ? iOrdinal != 1 ? iOrdinal != 3 ? iOrdinal != 4 ? flowableFromObservable.onBackpressureBuffer() : flowableFromObservable.onBackpressureLatest() : flowableFromObservable.onBackpressureDrop() : RxJavaPlugins.onAssembly(new FlowableOnBackpressureError(flowableFromObservable)) : flowableFromObservable;
    }
    ...
    public final Observable<T> repeat(long j) {
        ...
        throw new IllegalArgumentException(g9.a("times >= 0 required but it was ", j));
    }
    ...
    public final Observable<T> takeLast(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, boolean z, int i) {
        ...
        throw new IndexOutOfBoundsException(g9.a("count >= 0 required but it was ", j));
    }
