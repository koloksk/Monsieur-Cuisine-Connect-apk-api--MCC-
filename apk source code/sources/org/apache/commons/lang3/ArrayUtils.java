...
public class ArrayUtils {
    ...
    public static Object a(Object obj, Class<?> cls) throws NegativeArraySizeException {
        if (obj == null) {
    ...
    public static <T> T[] add(T[] tArr, T t) {
        ...
        T[] tArr2 = (T[]) ((Object[]) a(tArr, componentType));
    ...
    public static <T> T[] addAll(T[] tArr, T... tArr2) {
        ...
        try {
            ...
            StringBuilder sbA = g9.a("Cannot store ");
            sbA.append(componentType2.getName());
            sbA.append(" in an array of ");
            sbA.append(componentType.getName());
            throw new IllegalArgumentException(sbA.toString(), e);
        }
    }
    ...
    public static boolean[] insert(int i, boolean[] zArr, boolean... zArr2) {
        ...
        if (i < 0 || i > zArr.length) {
            StringBuilder sbA = g9.a("Index: ", i, ", Length: ");
    ...
    public static Object a(Object obj, int i, Object obj2, Class<?> cls) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        if (obj == null) {
            if (i == 0) {
    ...
    public static Object a(Object obj, int i) throws NegativeArraySizeException {
    ...
    public static Object a(Object obj, int... iArr) throws NegativeArraySizeException {
        int i;
        int i2;
        int length = getLength(obj);
    ...
    public static Object a(Object obj, BitSet bitSet) throws NegativeArraySizeException {
        int length = getLength(obj);
    ...
    public static <T> T[] removeAllOccurences(T[] tArr, T t) {
        ...
        while (true) {
            ...
            if (iIndexOf2 != -1) {
                ...
                return (T[]) removeAll(tArr, Arrays.copyOf(iArr, i));
            }
        }
    }
